...
- Ensure Puppeteer dependencies are installed. You can run the following command on your server (Ubuntu/Debian):

  ```bash
  # For Ubuntu 24.04+ (Noble) and newer Debian versions
  ...
  # For older Ubuntu versions (< 24.04)
