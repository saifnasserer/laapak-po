          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs font-bold text-green-600 uppercase tracking-widest">{t('generator')}</p>
              </div>
            </div>
        ...
        {clients.length === 0 ? (
          ...
          <div className="space-y-12">
            ...
            {favoriteClients.length > 0 && (
              <div>
                <SectionHeading icon={Star} count={favoriteClients.length}>{t('favorites')}</SectionHeading>
            ...
            {otherClients.length > 0 && (
              <div>
                <SectionHeading icon={Building2} count={otherClients.length}>
                  {favoriteClients.length > 0 ? t('otherClients') : t('allClients')}
                </SectionHeading>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
